    ...
    const fetchData = async () => {
      try {
        ...
        setDatos({
          ...
          ocupacion_trabajo: dataGraduado.ocupacion_trabajo,
          ocupacion_empresa: dataGraduado.ocupacion_empresa,
          ocupacion_sector: dataGraduado.ocupacion_sector,
          ocupacion_informacion_adicional: dataGraduado.ocupacion_informacion_adicional,
